...
| CampaignFeedbackLoopChainResponse | Feedback Loop Layer | API caller, CLI user | Read-only chain projection linking the baseline loop summary, outcome report, follow-up loop summary, and recommended operator focus |
